...
--
-- Table structure for table `videoc`
--

DROP TABLE IF EXISTS `videoc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `videoc` (
  `idvideoc` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2020-03-20 12:48:15
